...
export declare abstract class BaseColumnSeries extends XYSeries {
    ...
    protected _columnsUpdated: boolean;
    ...
    protected _updateGraphics(dataItem: DataItem<this["_dataItemSettings"]>, previousDataItem: DataItem<this["_dataItemSettings"]>, axisCase: 0 | 1 | 2): void;
