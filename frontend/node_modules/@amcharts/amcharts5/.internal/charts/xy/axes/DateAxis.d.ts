...
export declare class DateAxis<R extends AxisRenderer> extends ValueAxis<R> {
     ...
     * @ignore
     */
    getDataItemPositionX(dataItem: DataItem<IXYSeriesDataItem>, field: string, cellLocation: number, axisLocation: number, exactLocation?: boolean): number;
    /**
     * @ignore
     */
     ...
     * @ignore
     */
    getDataItemPositionY(dataItem: DataItem<IXYSeriesDataItem>, field: string, cellLocation: number, axisLocation: number, exactLocation?: boolean): number;
    /**
     * @ignore
     */
    ...
    protected _nextTime(time: number, count: number, baseInterval: ITimeInterval): number;
}
